...
Full HD 1920x1080 at 30 fps for the recorded video is best with Pi 4 and above.
 
In 4:3 (1.333) aspect ratio the max recommended resolution is 1600x1200, absolute limit is 1672x1254.
...
Any configuration changes made are stored internally after being submitted but are not applied 'on-the-fly' and only written to the .ini file on EXIT/SHUTDOWN or REBOOT, to take effect on the next startup.
