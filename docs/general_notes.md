...
The current default of buffer_seconds is set to 3 seconds, and while longer values are possible, excessive values eg > 10 seconds will increase the memory requirements and may lead to failures.
